...
return [
    'Yiisoft\\Rbac\\StorageInterface' => [
        ...
        '__construct()' => [
            'directory' => dirname(__DIR__, 2) . '\\resources\\rbac',
        ],
    ],
    ...
    'Yiisoft\\Router\\RouteCollectionInterface' => static function (\Yiisoft\Router\RouteCollectorInterface $collector) use ($config) {
        $collector->addGroup(
            \Yiisoft\Router\Group::create(null, $config->get('routes'))
    ...
    'Yiisoft\\Router\\RouteCollectorInterface' => unserialize('O:20:"Yiisoft\\Router\\Group":5:{s:8:"' . "\0" . '*' . "\0" . 'items";a:0:{}s:9:"' . "\0" . '*' . "\0" . 'prefix";N;s:24:"' . "\0" . '*' . "\0" . 'middlewareDefinitions";a:0:{}s:51:"' . "\0" . 'Yiisoft\\Router\\Group' . "\0" . 'disabledMiddlewareDefinitions";a:0:{}s:32:"' . "\0" . 'Yiisoft\\Router\\Group' . "\0" . 'dispatcher";N;}'),
